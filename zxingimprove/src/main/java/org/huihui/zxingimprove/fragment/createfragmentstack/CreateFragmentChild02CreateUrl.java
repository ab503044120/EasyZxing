...
public class CreateFragmentChild02CreateUrl extends AbstractCreateFragmentChild02Create
{
  ...
  protected List<Map<String, Object>> getTypeData()
  {
    ...
    int[] arrayOfInt1 = { 2131493147 };
    int[] arrayOfInt2 = { 2130837688 };
  ...
  protected boolean isCheckOutSuccess(ListEditorAdapter paramListEditorAdapter)
  {
    ...
    if ((str1 == null) || (str1.equals("")))
      str2 = getResources().getString(2131493087);
    while (str2 != null)
    {
      ...
      if (i <= 200)
        continue;
      str2 = getResources().getString(2131493085);
    }
    return true;
  }
}
 ...
 * Qualified Name:     mobi.thinkchange.android.superqrcode.fragment.createfragmentstack.CreateFragmentChild02CreateUrl
