...
public class CreateFragmentChild02CreateText extends AbstractCreateFragmentChild02Create
{
  ...
  protected List<Map<String, Object>> getTypeData()
  {
    ...
    int[] arrayOfInt1 = { 2131493166 };
    int[] arrayOfInt2 = { 2130837631 };
  ...
  protected boolean isCheckOutSuccess(ListEditorAdapter paramListEditorAdapter)
  {
    ...
    if ((str1 == null) || (str1.equals("")))
      str2 = getResources().getString(2131493083);
    while (str2 != null)
    {
      ...
      if (i <= 500)
        continue;
      str2 = getResources().getString(2131493086);
    }
    return true;
  }
}
 ...
 * Qualified Name:     mobi.thinkchange.android.superqrcode.fragment.createfragmentstack.CreateFragmentChild02CreateText
